...
public class BinderSender {
    ...
    private static final String PERMISSION_MANAGER = "com.renamedapps.sh1z0k0.permission.MANAGER";
    private static final String PERMISSION = "com.renamedapps.sh1z0k0.permission.API_V23";
