...
public class ServerConstants {
    ...
    public static final String PERMISSION = "com.renamedapps.sh1z0k0.permission.API_V23";
    public static final String MANAGER_APPLICATION_ID = "com.renamedapps.sh1z0k0";
